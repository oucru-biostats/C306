...
#' @param add.risk [TRUE] a logical value specifies whether the event probability ("absolute risk") at time "infinity" should be displayed.
...
#' @import survival
#' @export
sstable.survcomp <- function(model, data, add.risk = TRUE,
